...
def scrap_job_ok_and_expired(job_url):
   ...
   if "Daijob.com :: 'Jobs for international business professionals."  in driver.title: #---> job expired
      print("\n**** job is expired ***\n")
      job_company_name = job_type = job_industry = job_location = job_description = job_company_info = job_working_hours = job_requirnments = job_japanese_level = job_english_level = job_salary = job_other_salary_description = job_holidays = job_contract = job_nearest_station = "expired"
      driver.close() #->closing
      driver.quit()

      return job_company_name, job_type, job_industry, job_location, job_description, job_company_info, job_working_hours, job_requirnments, job_japanese_level, job_english_level, job_salary, job_other_salary_description, job_holidays, job_contract, job_nearest_station 
   
   else:  #job is not expired
      print("\n**** job is not expired ---> we call our parser ***\n")
      job_company_name, job_type, job_industry, job_location, job_description, job_company_info, job_working_hours, job_requirnments, job_japanese_level, job_english_level, job_salary, job_other_salary_description, job_holidays, job_contract, job_nearest_station = get_scrape_job_full_details_from_url(job_url)
      return job_company_name, job_type, job_industry, job_location, job_description, job_company_info, job_working_hours, job_requirnments, job_japanese_level, job_english_level, job_salary, job_other_salary_description, job_holidays, job_contract, job_nearest_station
...
def get_scrape_job_full_details_from_url(job_url):
   ...
   #initialization
   job_company_name = job_type = job_industry = job_location = job_description = job_company_info = job_working_hours = job_requirnments = job_japanese_level = job_english_level = job_salary = job_other_salary_description = job_holidays = job_contract = job_nearest_station = ""
   ...
   for div in mydivs0:
       ...
       #'''
       #'''
       for tr_tags_jobs_table03_table01_i in tr_tags_jobs_table03_table01:
        #
        th_tags_jobs_table03_table01_i = tr_tags_jobs_table03_table01_i.find_all("th")
        table_title = str(th_tags_jobs_table03_table01_i[0])
        print("table_title is: ", table_title)
        # the new for to be used with if cases ###############################################
        '''
        table_title is:  <th><span>Company Name</span></th>
        table_title is:  <th><span>Job Type</span></th>
        table_title is:  <th><span>Industry</span></th>
        table_title is:  <th><span>Location</span></th>
        table_title is:  <th><span>Job Description</span></th>
        table_title is:  <th><span>Company Info</span></th>
        table_title is:  <th><span>Working Hours</span></th>
        table_title is:  <th><span>Job<br/> Requirements</span></th>
        table_title is:  <th><span>English Level</span></th>
        table_title is:  <th><span>Japanese Level</span></th>
        table_title is:  <th><span>Salary</span></th>
        table_title is:  <th><span>Other Salary<br/> Description</span></th>
        table_title is:  <th><span>Holidays</span></th>
        table_title is:  <th><span>Job Contract<br/> Period</span></th>
        table_title is:  <th><span>Nearest Station</span></th>
        '''

        #--> # tr_tags_jobs_table03_table01[0] job_company_name
        if "company name" in table_title.lower():

         #-----------------------------------------------------------#
         try:
 
           h4_tags = tr_tags_jobs_table03_table01_i.find_all("h4")
        ...
        elif "job type" in table_title.lower():

       #-----------------------------------------------------------#
         try:

           a_tags = tr_tags_jobs_table03_table01_i.find_all("a")
           job_type = ""
           for a in a_tags:
              job_type = job_type + "\n" + a.text
         except:
       ...
       #-----------------------------------------------------------#
        ...
        elif "industry" in table_title.lower():
        ...
        elif "location" in table_title.lower():
        ...
        elif "job description" in table_title.lower():

         #-----------------------------------------------------------#
         try:

           td_tags = tr_tags_jobs_table03_table01_i.find_all("td")
        ...
        elif "company info" in table_title.lower():
        ...
        elif "working hours" in table_title.lower():
        ...
        elif "requirements" in table_title.lower():
       ...
       #-----------------------------------------------------------#
        ...
        elif "japanese level" in table_title.lower():
        ...
        #--> # tr_tags_jobs_table03_table01[8] job_japanese_level
        elif "english level" in table_title.lower():

         #-----------------------------------------------------------#
         try:

           td_tags = tr_tags_jobs_table03_table01_i.find_all("td")
           job_english_level = td_tags[0].text
         except:
           job_english_level = "not shown"
         print("job_english_level: ", job_english_level)
        ...
        elif "<span>salary" in table_title.lower(): #
        ...
        elif "> description<" in table_title.lower():
        ...
        elif "holidays" in table_title.lower():
        ...
        elif "job contract" in table_title.lower():
        ...
        elif "nearest station" in table_title.lower():
...
RESULT =  ['job_date', 'job_company_name', 'job_type', 'job_industry', 'job_location', 'job_description', 'job_company_info', 'job_working_hours', 'job_requirnments', 'job_japanese_level', 'job_english_level',  'job_salary', 'job_other_salary_description', 'job_holidays', 'job_contract', 'job_nearest_station']
...
for job_url, job_date in zip(job_url_list, job_date_list):
  ...
  job_company_name, job_type, job_industry, job_location, job_description, job_company_info, job_working_hours, job_requirnments, job_japanese_level, job_english_level, job_salary, job_other_salary_description, job_holidays, job_contract, job_nearest_station = scrap_job_ok_and_expired(job_url) #get_scrape_job_full_details_from_url(job_url)
  #job_date
...
#for i in range(0,len(job_company_name_list)):
  ...
  RESULT.append(job_english_level)
